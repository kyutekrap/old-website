...
if (isset($_POST['create'])) {
    ...
    $active = $_POST['active'];
    $time = time();
    $created_by = $_SESSION['rrm_username'];

    $insertQuery = "INSERT INTO rrm_contacts(`name`, `short_desc`, `active`, `created_by`, `created_on`) VALUES (?, ?, ?, ?, ?)";

    if ($insertStmt = mysqli_prepare($conn, $insertQuery)) {
        mysqli_stmt_bind_param($insertStmt, "ssiss", $name, $short_desc, $active, $created_by, $time);
...
<html>
    <head>
        ...
        <title>New Contact Method | RRM</title>
        ...
        <div class="form-container">
            <form class="modern-form" method="post">
              ...
              <div class="form-group">
                ...
                <input type="text" id="desc" name="short_desc" required maxlength=120>
              </div>
              <div class="form-group">
