...
if (isset($_POST['create'])) {
    ...
    $insertQuery = "INSERT INTO rrm_leads (`name`, `short_desc`, `stage`, `created_on`, `created_by`) VALUES (?, ?, ?, ?, ?)";

    if ($insertStmt = mysqli_prepare($conn, $insertQuery)) {
        mysqli_stmt_bind_param($insertStmt, "sssss", $name, $short_desc, $stage, $created_on, $created_by);
            ...
            <form class="modern-form" method="post">
              ...
              <div class="form-group">
                ...
                <div class="custom-select">
                    <select name="stage">
                      <option value="Acquaintenance">Acquaintenance</option>
